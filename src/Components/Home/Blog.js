    ...
    <div className="mx-10 my-10 mt-5 text-left">
      <div className="qna-section">
        ...
        <p>
          ...
          01. Keeping component state local where necessary We’ve learned that a
          ...
          02. Memoizing React components to prevent unnecessary re-renders
          ...
          changed. <br />
          03. Code-splitting in React using dynamic import() Code-splitting is
      ...
      <div className="qna-section">
        ...
        <p>
          ...
          01: Local (UI) state – Local state is data we manage in one or another
          component. Local state is most often managed in React using the
          useState hook. <br />
          02: Global (UI) state – Global state is data we manage across multiple
          ...
          03: Server state – Data that comes from an external server that must be
          ...
          <br />
          04: URL state – Data that exists on our URLs, including the pathname
