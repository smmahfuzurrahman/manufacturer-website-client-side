    ...
    return (
        <div class="hero w-full">
            <div class="hero-content flex-col lg:flex-row">
                <img className='w-full lg:w-96' src="https://media.istockphoto.com/vectors/anniversary-celebration-gold-icon-vector-id637019928?b=1&k=20&m=637019928&s=612x612&w=0&h=CFsmC9FqR5v9z3CBi8xEQ_4mJV83xVGGDAtMNBNMiuA=" class="max-w-sm rounded-lg shadow-2xl" alt='' />
